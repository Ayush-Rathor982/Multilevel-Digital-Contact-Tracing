for q in [5,10,20,50,80,150]:
    ...
    data_file = "/home/student/Desktop/new_project2/dependency_40per/Q"+str(q)+"_out_population10000/Data_size_for_population10000.txt"  # Assuming your file name is data.txt
    population = []
    arraysize = []
    listsize = []
    ...
    output_file = "/home/student/Desktop/new_project2/dependency_40per/Q_vs_Listsize.txt"
